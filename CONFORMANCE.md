...
| Página | 8-ST | EVD | CHIP | TOK | MON | PRV | BRC | TBL | MOB | Fase |
|---|---|---|---|---|---|---|---|---|---|---|
| Login | ❌ | ➖ | ➖ | ⏳ | ➖ | ➖ | ➖ | ➖ | ❌ | P7 |
| Signup | ❌ | ➖ | ➖ | ⏳ | ➖ | ➖ | ➖ | ➖ | ❌ | P7 |
| AuthCallback | ❌ | ➖ | ➖ | ⏳ | ➖ | ➖ | ➖ | ➖ | ❌ | P7 |
...
| P2 · Signal Ledger + Observe | LiveEvents, EventDetail, Ledger, Signals, Reconciliation, Monitoring | ⏸ aguarda validação da matriz |
